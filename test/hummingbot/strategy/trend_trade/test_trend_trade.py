...
class TrendTradeUnitTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.buy_mid_price_strategy: TrendTradeStrategy = TrendTradeStrategy(
        ...
        self.sell_mid_price_strategy: TrendTradeStrategy = TrendTradeStrategy(
            exchange=self.market,
            trading_pair=self.trading_pair,
            is_buy=False,
            spread=self.spread,
        ...
        self.buy_last_price_strategy: TrendTradeStrategy = TrendTradeStrategy(
            exchange=self.market,
            trading_pair=self.trading_pair,
            is_buy=True,
            spread=self.spread,
        ...
        self.sell_last_price_strategy: TrendTradeStrategy = TrendTradeStrategy(
            exchange=self.market,
            trading_pair=self.trading_pair,
            is_buy=False,
            spread=self.spread,
        ...
        self.buy_last_own_trade_price_strategy: TrendTradeStrategy = TrendTradeStrategy(
            exchange=self.market,
            trading_pair=self.trading_pair,
            is_buy=True,
            spread=self.spread,
        ...
        self.sell_last_own_trade_price_strategy: TrendTradeStrategy = TrendTradeStrategy(
            exchange=self.market,
            trading_pair=self.trading_pair,
            is_buy=False,
            spread=self.spread,
